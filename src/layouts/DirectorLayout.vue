        ...
        <aside class="w-64 bg-base-100 shadow-xl flex-shrink-0">
            <div class="p-4">
                <div class="flex items-center space-x-3 mb-8">
                    <div
                        class="w-12 h-12 bg-primary text-primary-content rounded-full flex items-center justify-center">
                ...
                <ul class="menu p-0 text-base-content">
                    ...
                    <li>
                        <router-link to="/director/orders" class="flex items-center space-x-3"
                            :class="{ 'active': isActive('/director/orders') }">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
